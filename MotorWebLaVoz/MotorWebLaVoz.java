...
public class MotorWebLaVoz {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PrintWriter salidadirecciones = new PrintWriter(new FileWriter("urlsLaVoz.txt"));
            PrintWriter salidaarts = new PrintWriter(new FileWriter("Articulos_LaVoz.txt"));
            ...
            for (i = 0; i <= 246; i++) {
                ...
                //System.out.println("\n"+i+"\n");
                    //text = "\n---------------------------------------------------------Separador---------------------------------------------------------\n";
                //salida.println(text);
                urlPersonalizado = "http://www.lavoz.com.ar/search/lavoz/" + palabraClave[j] + "?page=" + i;
                ...
                if (statusCode == 200 /* la página respondió OK */) {
                    ...
                    while ((line = bufferedReader.readLine()) != null) {
                        ...
                        if (line.contains("<h3 class=\"title\">")) {
                            ...
                            if((inicio != -1) && (inicio < fin)){                    
                                if(line.substring(inicio, fin).contains("http://www.lavoz.com.ar/")){
            ...
            for (int k = 0; k < direcciones.size(); k++) {
                ...
                if (statusCode == 200 /* la página respondió OK */) {
                    ...
                    while ((line = bufferedReader.readLine()) != null) {
						...
						//Para escribir la fecha del articulo
                        ...
                        if ( line.contains("TextoNota") ) {
                            ban = 1;
                        }

                        if ( (line.contains("<div class=\"publicidad sinBorde adGoogle\">")) ){
                            ban = 0;
                        }
