 ...
 */
//package motorwebfolhadesaopaulo;
 ...
 */
public class MotorWebFolhaDeSaoPaulo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PrintWriter salidadirecciones = new PrintWriter(new FileWriter("urlsFolhaDeSaoPaulo.txt"));
            PrintWriter salidaarts = new PrintWriter(new FileWriter("Articulos_FolhaDeSaoPaulo.txt"));
            ...
            for (i = 1; i <= 10494; i+=25) {

                //prueba
                //System.out.println("\n"+i+"\n");
                    //text = "\n---------------------------------------------------------Separador---------------------------------------------------------\n";
                //salida.println(text);
                urlPersonalizado = "http://search.folha.com.br/search?q=" + palabraClave[j] + "&site=online&sr=" + i;
                ...
                if (statusCode == 200 /* la página respondió OK */) {
                    ...
                    while ((line = bufferedReader.readLine()) != null) {
                        ...
                        if (line.contains("search-results-title")) {
                            inicio = line.indexOf("http");
                            fin = line.indexOf("html") + 5;
                            ...
                            if((inicio != -1) && (inicio < fin)){                    
                                if(line.substring(inicio, fin).contains("http://www1.folha.uol.com.br")){
            ...
            for (int k = 0; k < direcciones.size(); k++) {
                ...
                if (statusCode == 200 /* la página respondió OK */) {
                    ...
                    while ((line = bufferedReader.readLine()) != null) {
                        ...
                        if ( (line.contains("<p class=\"star\">")) || (line.contains("<aside>")) ) {
                            ban = 0;
                        }
