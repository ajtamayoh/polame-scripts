...
public class MotorWebOGlobo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PrintWriter salidadirecciones = new PrintWriter(new FileWriter("urlsOGlobo.txt"));
            PrintWriter salidaarts = new PrintWriter(new FileWriter("Articulos_OGlobo.txt"));
            ...
            for (i = 1; i <= 1471; i++) {
                ...
                //System.out.println("\n"+i+"\n");
                    //text = "\n---------------------------------------------------------Separador---------------------------------------------------------\n";
                //salida.println(text);
                urlPersonalizado = "http://g1.globo.com/busca/?q=" + palabraClave[j] + "&cat=b&st=G1&sct=G1&page=" + i;
                    ...
                    while ((line = bufferedReader.readLine()) != null) {
                        ...
                        if (line.contains("title=")) {
                            ...
                            if((inicio != -1) && (inicio < fin)){                    
                                if(line.substring(inicio, fin).contains("http://g1.globo.com/")){
            ...
            for (int k = 0; k < direcciones.size(); k++) {
                ...
                if (statusCode == 200 /* la página respondió OK */) {
                    ...
                    while ((line = bufferedReader.readLine()) != null) {
                        ...
                        if ( line.contains("class=\"materia-conteudo") ) {
                            ban = 1;
                        }

                        if ( (line.contains("<!-- google_ad_section_end -->")) ){
                            ban = 0;
                        }
